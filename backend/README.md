...
## Project Structure
    ...
    ├── testapiautocatalog_116185  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_116185`
...
2. Clone this repo and `cd testapiautocatalog_116185`
